...
{
    public partial class frmAverageResortWear : Form
    {
        public frmAverageResortWear()
        {
            InitializeComponent();
        }

        private void frmAverageResortWear_Load(object sender, EventArgs e)
        {
            FillDatagridviewAverageResortWear();
        }

        AverageResortWearDAL resortWearDatagridviewAverage = new AverageResortWearDAL();
        public void FillDatagridviewAverageResortWear()
        {
            //Refreshing Data Grid View
            DataTable dt = resortWearDatagridviewAverage.Select();
            bunifuDataGridAverageResortWear.DataSource = dt;

            bunifuDataGridAverageResortWear.Columns[1].Width = 90;
            bunifuDataGridAverageResortWear.Columns[3].Width = 100;
            bunifuDataGridAverageResortWear.Columns[4].Width = 50;

            bunifuDataGridAverageResortWear.Columns[0].Visible = false;

            foreach (DataGridViewColumn column in bunifuDataGridAverageResortWear.Columns)
            {
                column.SortMode = DataGridViewColumnSortMode.NotSortable;
            }

            bunifuDataGridAverageResortWear.Columns[1].HeaderText = "Candidate #";
            bunifuDataGridAverageResortWear.Columns[2].HeaderText = "Candidate Name";
        ...
        private void bunifuDataGridAverageResortWear_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (e.ColumnIndex == 3)
            {
        ...
        private void btnPrintAverageResortWear_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            Bitmap objBmp = new Bitmap(this.bunifuDataGridAverageResortWear.Width, this.bunifuDataGridAverageResortWear.Height);
            bunifuDataGridAverageResortWear.DrawToBitmap(objBmp, new Rectangle(0, 0, this.bunifuDataGridAverageResortWear.Width, this.bunifuDataGridAverageResortWear.Height));
