...
{
    public partial class frmAverageEveningGown : Form
    {
        public frmAverageEveningGown()
        {
            InitializeComponent();
        }

        private void frmAverageEveningGown_Load(object sender, EventArgs e)
        {
            FillDatagridviewAverageEveningGown();
        }

        AverageEveningGownDAL eveningGownDatagridviewAverage = new AverageEveningGownDAL();
        public void FillDatagridviewAverageEveningGown()
        {
            //Refreshing Data Grid View
            DataTable dt = eveningGownDatagridviewAverage.Select();
            bunifuDataGridAverageEveningGown.DataSource = dt;

            bunifuDataGridAverageEveningGown.Columns[1].Width = 90;
            bunifuDataGridAverageEveningGown.Columns[3].Width = 100;
            bunifuDataGridAverageEveningGown.Columns[4].Width = 50;

            bunifuDataGridAverageEveningGown.Columns[0].Visible = false;

            foreach (DataGridViewColumn column in bunifuDataGridAverageEveningGown.Columns)
            {
                column.SortMode = DataGridViewColumnSortMode.NotSortable;
            }

            bunifuDataGridAverageEveningGown.Columns[1].HeaderText = "Candidate #";
            bunifuDataGridAverageEveningGown.Columns[2].HeaderText = "Candidate Name";
        ...
        private void bunifuDataGridAverageEveningGown_CellFormatting(object sender, DataGridViewCellFormattingEventArgs e)
        {
            if (e.ColumnIndex == 3)
            {
        ...
        private void btnPrintAverageEveningGown_Click(object sender, EventArgs e)
        {
            try
            {
        ...
        {
            Bitmap objBmp = new Bitmap(this.bunifuDataGridAverageEveningGown.Width, this.bunifuDataGridAverageEveningGown.Height);
            bunifuDataGridAverageEveningGown.DrawToBitmap(objBmp, new Rectangle(0, 0, this.bunifuDataGridAverageEveningGown.Width, this.bunifuDataGridAverageEveningGown.Height));
