...
{
    public partial class frmJudge5 : Form
    {
        public frmJudge5()
        {
            InitializeComponent();
        ...
        private async void frmJudge5_Load(object sender, EventArgs e)
        {
        ...
        public void FillTxtboxJudge5Name()
        {
            using (SqlConnection conn = new SqlConnection(UserDAL.myconnstrng))
            {
                string query = "SELECT Judge5Name FROM tbl_JudgesAndAdmin";
                SqlCommand cmd = new SqlCommand(query, conn);
        ...
        private void cmbCategories_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                InitTimerJ5Name();
                panelWelcomeJudge5.BringToFront();
                lblJudgeName.Focus();
            }
            else if (cmbCategories.SelectedIndex == 1)
            {
                btnJudge5TalentSend.Visible = true;

                btnJudge5ProductionNumberSend.Visible = false;
                btnJudge5EveningGownSend.Visible = false;
                btnJudge5ResortWearSend.Visible = false;
                btnJudge5OnStageQuestionsSend.Visible = false;
                ...
                btnJudge5TalentSend.BringToFront();
            ...
            {
                btnJudge5ProductionNumberSend.Visible = true;

                btnJudge5TalentSend.Visible = false;
                btnJudge5EveningGownSend.Visible = false;
                btnJudge5ResortWearSend.Visible = false;
                btnJudge5OnStageQuestionsSend.Visible = false;
                ...
                btnJudge5ProductionNumberSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge5EveningGownSend.Visible = true;
                ...
                btnJudge5EveningGownSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge5ResortWearSend.Visible = true;
                ...
                btnJudge5ResortWearSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge5OnStageQuestionsSend.Visible = true;
                ...
                btnJudge5OnStageQuestionsSend.BringToFront();
                panelBody.BringToFront();
                Clear();
        ...
        JudgeBLL judge5BLL = new JudgeBLL();
        Judge5TalentDAL judge5TalentDAL = new Judge5TalentDAL();
        private void SendScoreJudge5Talent()
        {
            ...
            judge5BLL.Score1 = score1;
            judge5BLL.Score2 = score2;
            judge5BLL.Score3 = score3;
            judge5BLL.Score4 = score4;
            judge5BLL.Score5 = score5;
            judge5BLL.Score6 = score6;
            judge5BLL.Score7 = score7;
            judge5BLL.Score8 = score8;
            judge5BLL.Score9 = score9;
            judge5BLL.Score10 = score10;
            judge5BLL.Score11 = score11;
            judge5BLL.Score12 = score12;
            judge5BLL.Score13 = score13;
            judge5BLL.Score14 = score14;
            judge5BLL.Score15 = score15;

            // Updating data into Database
            bool success = judge5TalentDAL.Update1(judge5BLL);
            judge5TalentDAL.Update2(judge5BLL);
            judge5TalentDAL.Update3(judge5BLL);
            judge5TalentDAL.Update4(judge5BLL);
            judge5TalentDAL.Update5(judge5BLL);
            judge5TalentDAL.Update6(judge5BLL);
            judge5TalentDAL.Update7(judge5BLL);
            judge5TalentDAL.Update8(judge5BLL);
            judge5TalentDAL.Update9(judge5BLL);
            judge5TalentDAL.Update10(judge5BLL);
            judge5TalentDAL.Update11(judge5BLL);
            judge5TalentDAL.Update12(judge5BLL);
            judge5TalentDAL.Update13(judge5BLL);
            judge5TalentDAL.Update14(judge5BLL);
            judge5TalentDAL.Update15(judge5BLL);

            // If the data is successfully updated then the value of success will be true else it will be false
            if (success == true)
            {
                // Data successfully updated
                MessageBox.Show("Thank you, for sending the scores '" + lblJudgeName.Text + "'.", "Judge5 Sent Successfully!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                // Failed to update data
                MessageBox.Show("Failed to send new score information.", "Judge5 Information Warning!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }

        Judge5ProductionNoDAL judge5ProductionNoDAL = new Judge5ProductionNoDAL();
        private void SendScoreJudge5ProductionNo()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            judge5BLL.Total = total;

            // Updating data into Database
            bool success = judge5ProductionNoDAL.Update1(judge5BLL);
            judge5ProductionNoDAL.Update2(judge5BLL);
            judge5ProductionNoDAL.Update3(judge5BLL);
            judge5ProductionNoDAL.Update4(judge5BLL);
            judge5ProductionNoDAL.Update5(judge5BLL);
            judge5ProductionNoDAL.Update6(judge5BLL);
            judge5ProductionNoDAL.Update7(judge5BLL);
            judge5ProductionNoDAL.Update8(judge5BLL);
            judge5ProductionNoDAL.Update9(judge5BLL);
            judge5ProductionNoDAL.Update10(judge5BLL);
            judge5ProductionNoDAL.Update11(judge5BLL);
            judge5ProductionNoDAL.Update12(judge5BLL);
            judge5ProductionNoDAL.Update13(judge5BLL);
            judge5ProductionNoDAL.Update14(judge5BLL);
            judge5ProductionNoDAL.Update15(judge5BLL);

            judge5ProductionNoDAL.UpdateDependency1(judge5BLL);
        ...
        Judge5EveningGownDAL judge5EveningGownDAL = new Judge5EveningGownDAL();
        private void SendScoreJudge5EveningGown()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge5EveningGownDAL.Update1(judge5BLL);
            judge5EveningGownDAL.Update2(judge5BLL);
            judge5EveningGownDAL.Update3(judge5BLL);
            judge5EveningGownDAL.Update4(judge5BLL);
            judge5EveningGownDAL.Update5(judge5BLL);
            judge5EveningGownDAL.Update6(judge5BLL);
            judge5EveningGownDAL.Update7(judge5BLL);
            judge5EveningGownDAL.Update8(judge5BLL);
            judge5EveningGownDAL.Update9(judge5BLL);
            judge5EveningGownDAL.Update10(judge5BLL);
            judge5EveningGownDAL.Update11(judge5BLL);
            judge5EveningGownDAL.Update12(judge5BLL);
            judge5EveningGownDAL.Update13(judge5BLL);
            judge5EveningGownDAL.Update14(judge5BLL);
            judge5EveningGownDAL.Update15(judge5BLL);

            judge5EveningGownDAL.UpdateDependency1(judge5BLL);
        ...
        Judge5ResortWearDAL judge5ResortWearDAL = new Judge5ResortWearDAL();
        private void SendScoreJudge5ResortWear()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge5ResortWearDAL.Update1(judge5BLL);
            judge5ResortWearDAL.Update2(judge5BLL);
            judge5ResortWearDAL.Update3(judge5BLL);
            judge5ResortWearDAL.Update4(judge5BLL);
            judge5ResortWearDAL.Update5(judge5BLL);
            judge5ResortWearDAL.Update6(judge5BLL);
            judge5ResortWearDAL.Update7(judge5BLL);
            judge5ResortWearDAL.Update8(judge5BLL);
            judge5ResortWearDAL.Update9(judge5BLL);
            judge5ResortWearDAL.Update10(judge5BLL);
            judge5ResortWearDAL.Update11(judge5BLL);
            judge5ResortWearDAL.Update12(judge5BLL);
            judge5ResortWearDAL.Update13(judge5BLL);
            judge5ResortWearDAL.Update14(judge5BLL);
            judge5ResortWearDAL.Update15(judge5BLL);

            judge5ResortWearDAL.UpdateDependency1(judge5BLL);
        ...
        Judge5OnStageQuestionsDAL judge5OnStageQuestionsDAL = new Judge5OnStageQuestionsDAL();
        private void SendScoreJudge5OnStageQuestions()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge5OnStageQuestionsDAL.Update1(judge5BLL);
            judge5OnStageQuestionsDAL.Update2(judge5BLL);
            judge5OnStageQuestionsDAL.Update3(judge5BLL);
            judge5OnStageQuestionsDAL.Update4(judge5BLL);
            judge5OnStageQuestionsDAL.Update5(judge5BLL);
            judge5OnStageQuestionsDAL.Update6(judge5BLL);
            judge5OnStageQuestionsDAL.Update7(judge5BLL);
            judge5OnStageQuestionsDAL.Update8(judge5BLL);
            judge5OnStageQuestionsDAL.Update9(judge5BLL);
            judge5OnStageQuestionsDAL.Update10(judge5BLL);
            judge5OnStageQuestionsDAL.Update11(judge5BLL);
            judge5OnStageQuestionsDAL.Update12(judge5BLL);
            judge5OnStageQuestionsDAL.Update13(judge5BLL);
            judge5OnStageQuestionsDAL.Update14(judge5BLL);
            judge5OnStageQuestionsDAL.Update15(judge5BLL);

            judge5OnStageQuestionsDAL.UpdateDependency1(judge5BLL);
        ...
        Judge5Top5DAL judge5Top5DAL = new Judge5Top5DAL();
        private void SendScoreJudge5Top5()
        {
            ...
            // Updating data into Database
            bool success = judge5Top5DAL.Update1(judge5BLL);
            judge5Top5DAL.Update2(judge5BLL);
            judge5Top5DAL.Update3(judge5BLL);
            judge5Top5DAL.Update4(judge5BLL);
            judge5Top5DAL.Update5(judge5BLL);

            judge5Top5DAL.UpdateDependency1(judge5BLL);
        ...
        private void btnJudge5TalentSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorFormBestInTalent())
            {
                ...
                {
                    FillTxtboxJudge5Name();
                    SendScoreJudge5Talent();

                    btnJudge5TalentSend.Enabled = false;
                    btnJudge5TalentSend.LabelText = "Scores already sent!";
                    btnJudge5TalentSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge5ProductionNumberSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    FillTxtboxJudge5Name();
                    SendScoreJudge5ProductionNo();

                    btnJudge5ProductionNumberSend.Enabled = false;
                    btnJudge5ProductionNumberSend.LabelText = "Scores already sent!";
                    btnJudge5ProductionNumberSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge5EveningGownSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge5EveningGown();

                    btnJudge5EveningGownSend.Enabled = false;
                    btnJudge5EveningGownSend.LabelText = "Scores already sent!";
                    btnJudge5EveningGownSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge5ResortWearSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge5ResortWear();

                    btnJudge5ResortWearSend.Enabled = false;
                    btnJudge5ResortWearSend.LabelText = "Scores already sent!";
                    btnJudge5ResortWearSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge5OnStageQuestionsSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge5OnStageQuestions();

                    btnJudge5OnStageQuestionsSend.Enabled = false;
                    btnJudge5OnStageQuestionsSend.LabelText = "Scores already sent!";
                    btnJudge5OnStageQuestionsSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge5Top5Send_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    btnJudge5Top5Send.Enabled = false;
                    btnJudge5Top5Send.LabelText = "Scores already sent!";
                    btnJudge5Top5Send.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private Timer timerJ5Name;
        public void InitTimerJ5Name()
        {
            timerJ5Name = new Timer();
            timerJ5Name.Tick += new EventHandler(timerJudge5Name_Tick);
            timerJ5Name.Interval = 3000; // in milliseconds
            timerJ5Name.Start();
        }

        private void timerJudge5Name_Tick(object sender, EventArgs e)
        {
            if (cmbCategories.SelectedIndex == 0)
            {
                timerJ5Name.Start();
        ...
        private void btnScoreCandidate1_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate1())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score1 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update1(judge5BLL);
                    judge5TalentDAL.UpdateDependency1(judge5BLL);
        ...
        private void btnScoreCandidate2_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate2())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score2 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update2(judge5BLL);
                    judge5TalentDAL.UpdateDependency2(judge5BLL);
        ...
        private void btnScoreCandidate3_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate3())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score3 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update3(judge5BLL);
                    judge5TalentDAL.UpdateDependency3(judge5BLL);
        ...
        private void btnScoreCandidate4_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate4())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score4 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update4(judge5BLL);
                    judge5TalentDAL.UpdateDependency4(judge5BLL);
        ...
        private void btnScoreCandidate5_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate5())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score5 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update5(judge5BLL);
                    judge5TalentDAL.UpdateDependency5(judge5BLL);
        ...
        private void btnScoreCandidate6_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate6())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score6 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update6(judge5BLL);
                    judge5TalentDAL.UpdateDependency6(judge5BLL);
        ...
        private void btnScoreCandidate7_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate7())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score7 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update7(judge5BLL);
                    judge5TalentDAL.UpdateDependency7(judge5BLL);
        ...
        private void btnScoreCandidate8_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate8())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score8 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update8(judge5BLL);
                    judge5TalentDAL.UpdateDependency8(judge5BLL);
        ...
        private void btnScoreCandidate9_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate9())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score9 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update9(judge5BLL);
                    judge5TalentDAL.UpdateDependency9(judge5BLL);
        ...
        private void btnScoreCandidate10_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate10())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score10 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update10(judge5BLL);
                    judge5TalentDAL.UpdateDependency10(judge5BLL);
        ...
        private void btnScoreCandidate11_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate11())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score11 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update11(judge5BLL);
                    judge5TalentDAL.UpdateDependency11(judge5BLL);
        ...
        private void btnScoreCandidate12_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate12())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score12 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update12(judge5BLL);
                    judge5TalentDAL.UpdateDependency12(judge5BLL);
        ...
        private void btnScoreCandidate13_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate13())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score13 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update13(judge5BLL);
                    judge5TalentDAL.UpdateDependency13(judge5BLL);
        ...
        private void btnScoreCandidate14_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate14())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score14 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update14(judge5BLL);
                    judge5TalentDAL.UpdateDependency14(judge5BLL);
        ...
        private void btnScoreCandidate15_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate15())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge5BLL.Score15 = total;


                    // Updating data into Database
                    bool success = judge5TalentDAL.Update15(judge5BLL);
                    judge5TalentDAL.UpdateDependency15(judge5BLL);
        ...
        private void btnSendToBackBestInTalentPanel_Click(object sender, EventArgs e)
        {
            ...
            lblCandidateName.ForeColor = Color.OrangeRed;
            lblScore.ForeColor = Color.OrangeRed;
            btnJudge5TalentSend.SendToBack();
            panelBody.BringToFront();
            Clear();
