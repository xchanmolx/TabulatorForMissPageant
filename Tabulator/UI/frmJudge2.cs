...
{
    public partial class frmJudge2 : Form
    {
        public frmJudge2()
        {
            InitializeComponent();
        ...
        private async void frmJudge2_Load(object sender, EventArgs e)
        {
        ...
        public void FillTxtboxJudge2Name()
        {
            using (SqlConnection conn = new SqlConnection(UserDAL.myconnstrng))
            {
                string query = "SELECT Judge2Name FROM tbl_JudgesAndAdmin";
                SqlCommand cmd = new SqlCommand(query, conn);
        ...
        private void cmbCategories_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                InitTimerJ2Name();
                panelWelcomeJudge2.BringToFront();
                lblJudgeName.Focus();
            }
            else if (cmbCategories.SelectedIndex == 1)
            {
                btnJudge2TalentSend.Visible = true;

                btnJudge2ProductionNumberSend.Visible = false;
                btnJudge2EveningGownSend.Visible = false;
                btnJudge2ResortWearSend.Visible = false;
                btnJudge2OnStageQuestionsSend.Visible = false;
                ...
                btnJudge2TalentSend.BringToFront();
            ...
            {
                btnJudge2ProductionNumberSend.Visible = true;

                btnJudge2TalentSend.Visible = false;
                btnJudge2EveningGownSend.Visible = false;
                btnJudge2ResortWearSend.Visible = false;
                btnJudge2OnStageQuestionsSend.Visible = false;
                ...
                btnJudge2ProductionNumberSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge2EveningGownSend.Visible = true;
                ...
                btnJudge2EveningGownSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge2ResortWearSend.Visible = true;
                ...
                btnJudge2ResortWearSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge2OnStageQuestionsSend.Visible = true;
                ...
                btnJudge2OnStageQuestionsSend.BringToFront();
                panelBody.BringToFront();
                Clear();
        ...
        JudgeBLL judge2BLL = new JudgeBLL();
        Judge2TalentDAL judge2DAL = new Judge2TalentDAL();
        private void SendScoreJudge2Talent()
        {
            ...
            judge2BLL.Score1 = score1;
            judge2BLL.Score2 = score2;
            judge2BLL.Score3 = score3;
            judge2BLL.Score4 = score4;
            judge2BLL.Score5 = score5;
            judge2BLL.Score6 = score6;
            judge2BLL.Score7 = score7;
            judge2BLL.Score8 = score8;
            judge2BLL.Score9 = score9;
            judge2BLL.Score10 = score10;
            judge2BLL.Score11 = score11;
            judge2BLL.Score12 = score12;
            judge2BLL.Score13 = score13;
            judge2BLL.Score14 = score14;
            judge2BLL.Score15 = score15;

            // Updating data into Database
            bool success = judge2DAL.Update1(judge2BLL);
            judge2DAL.Update2(judge2BLL);
            judge2DAL.Update3(judge2BLL);
            judge2DAL.Update4(judge2BLL);
            judge2DAL.Update5(judge2BLL);
            judge2DAL.Update6(judge2BLL);
            judge2DAL.Update7(judge2BLL);
            judge2DAL.Update8(judge2BLL);
            judge2DAL.Update9(judge2BLL);
            judge2DAL.Update10(judge2BLL);
            judge2DAL.Update11(judge2BLL);
            judge2DAL.Update12(judge2BLL);
            judge2DAL.Update13(judge2BLL);
            judge2DAL.Update14(judge2BLL);
            judge2DAL.Update15(judge2BLL);

            // If the data is successfully updated then the value of success will be true else it will be false
            if (success == true)
            {
                // Data successfully updated
                MessageBox.Show("Thank you, for sending the scores '" + lblJudgeName.Text + "'.", "Judge2 Sent Successfully!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                // Failed to update data
                MessageBox.Show("Failed to send new score information.", "Judge2 Information Warning!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }

        Judge2ProductionNoDAL judge2ProductionNoDAL = new Judge2ProductionNoDAL();
        private void SendScoreJudge2ProductionNo()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            judge2BLL.Total = total;

            // Updating data into Database
            bool success = judge2ProductionNoDAL.Update1(judge2BLL);
            judge2ProductionNoDAL.Update2(judge2BLL);
            judge2ProductionNoDAL.Update3(judge2BLL);
            judge2ProductionNoDAL.Update4(judge2BLL);
            judge2ProductionNoDAL.Update5(judge2BLL);
            judge2ProductionNoDAL.Update6(judge2BLL);
            judge2ProductionNoDAL.Update7(judge2BLL);
            judge2ProductionNoDAL.Update8(judge2BLL);
            judge2ProductionNoDAL.Update9(judge2BLL);
            judge2ProductionNoDAL.Update10(judge2BLL);
            judge2ProductionNoDAL.Update11(judge2BLL);
            judge2ProductionNoDAL.Update12(judge2BLL);
            judge2ProductionNoDAL.Update13(judge2BLL);
            judge2ProductionNoDAL.Update14(judge2BLL);
            judge2ProductionNoDAL.Update15(judge2BLL);

            judge2ProductionNoDAL.UpdateDependency1(judge2BLL);
        ...
        Judge2EveningGownDAL judge2EveningGownDAL = new Judge2EveningGownDAL();
        private void SendScoreJudge2EveningGown()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge2EveningGownDAL.Update1(judge2BLL);
            judge2EveningGownDAL.Update2(judge2BLL);
            judge2EveningGownDAL.Update3(judge2BLL);
            judge2EveningGownDAL.Update4(judge2BLL);
            judge2EveningGownDAL.Update5(judge2BLL);
            judge2EveningGownDAL.Update6(judge2BLL);
            judge2EveningGownDAL.Update7(judge2BLL);
            judge2EveningGownDAL.Update8(judge2BLL);
            judge2EveningGownDAL.Update9(judge2BLL);
            judge2EveningGownDAL.Update10(judge2BLL);
            judge2EveningGownDAL.Update11(judge2BLL);
            judge2EveningGownDAL.Update12(judge2BLL);
            judge2EveningGownDAL.Update13(judge2BLL);
            judge2EveningGownDAL.Update14(judge2BLL);
            judge2EveningGownDAL.Update15(judge2BLL);

            judge2EveningGownDAL.UpdateDependency1(judge2BLL);
        ...
        Judge2ResortWearDAL judge2ResortWearDAL = new Judge2ResortWearDAL();
        private void SendScoreJudge2ResortWear()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge2ResortWearDAL.Update1(judge2BLL);
            judge2ResortWearDAL.Update2(judge2BLL);
            judge2ResortWearDAL.Update3(judge2BLL);
            judge2ResortWearDAL.Update4(judge2BLL);
            judge2ResortWearDAL.Update5(judge2BLL);
            judge2ResortWearDAL.Update6(judge2BLL);
            judge2ResortWearDAL.Update7(judge2BLL);
            judge2ResortWearDAL.Update8(judge2BLL);
            judge2ResortWearDAL.Update9(judge2BLL);
            judge2ResortWearDAL.Update10(judge2BLL);
            judge2ResortWearDAL.Update11(judge2BLL);
            judge2ResortWearDAL.Update12(judge2BLL);
            judge2ResortWearDAL.Update13(judge2BLL);
            judge2ResortWearDAL.Update14(judge2BLL);
            judge2ResortWearDAL.Update15(judge2BLL);

            judge2ResortWearDAL.UpdateDependency1(judge2BLL);
        ...
        Judge2OnStageQuestionsDAL judge2OnStageQuestionsDAL = new Judge2OnStageQuestionsDAL();
        private void SendScoreJudge2OnStageQuestions()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge2OnStageQuestionsDAL.Update1(judge2BLL);
            judge2OnStageQuestionsDAL.Update2(judge2BLL);
            judge2OnStageQuestionsDAL.Update3(judge2BLL);
            judge2OnStageQuestionsDAL.Update4(judge2BLL);
            judge2OnStageQuestionsDAL.Update5(judge2BLL);
            judge2OnStageQuestionsDAL.Update6(judge2BLL);
            judge2OnStageQuestionsDAL.Update7(judge2BLL);
            judge2OnStageQuestionsDAL.Update8(judge2BLL);
            judge2OnStageQuestionsDAL.Update9(judge2BLL);
            judge2OnStageQuestionsDAL.Update10(judge2BLL);
            judge2OnStageQuestionsDAL.Update11(judge2BLL);
            judge2OnStageQuestionsDAL.Update12(judge2BLL);
            judge2OnStageQuestionsDAL.Update13(judge2BLL);
            judge2OnStageQuestionsDAL.Update14(judge2BLL);
            judge2OnStageQuestionsDAL.Update15(judge2BLL);

            judge2OnStageQuestionsDAL.UpdateDependency1(judge2BLL);
        ...
        Judge2Top5DAL judge2Top5 = new Judge2Top5DAL();
        private void SendScoreJudge2Top5()
        {
            ...
            // Updating data into Database
            bool success = judge2Top5.Update1(judge2BLL);
            judge2Top5.Update2(judge2BLL);
            judge2Top5.Update3(judge2BLL);
            judge2Top5.Update4(judge2BLL);
            judge2Top5.Update5(judge2BLL);

            judge2Top5.UpdateDependency1(judge2BLL);
        ...
        private void btnJudge2TalentSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorFormBestInTalent())
            {
                ...
                {
                    FillTxtboxJudge2Name();
                    SendScoreJudge2Talent();

                    btnJudge2TalentSend.Enabled = false;
                    btnJudge2TalentSend.LabelText = "Scores already sent!";
                    btnJudge2TalentSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge2ProductionNumberSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    FillTxtboxJudge2Name();
                    SendScoreJudge2ProductionNo();

                    btnJudge2ProductionNumberSend.Enabled = false;
                    btnJudge2ProductionNumberSend.LabelText = "Scores already sent!";
                    btnJudge2ProductionNumberSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }
        
        private void btnJudge2EveningGownSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge2EveningGown();

                    btnJudge2EveningGownSend.Enabled = false;
                    btnJudge2EveningGownSend.LabelText = "Scores already sent!";
                    btnJudge2EveningGownSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge2ResortWearSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge2ResortWear();

                    btnJudge2ResortWearSend.Enabled = false;
                    btnJudge2ResortWearSend.LabelText = "Scores already sent!";
                    btnJudge2ResortWearSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge2OnStageQuestionsSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge2OnStageQuestions();

                    btnJudge2OnStageQuestionsSend.Enabled = false;
                    btnJudge2OnStageQuestionsSend.LabelText = "Scores already sent!";
                    btnJudge2OnStageQuestionsSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge2Top5Send_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    btnJudge2Top5Send.Enabled = false;
                    btnJudge2Top5Send.LabelText = "Scores already sent!";
                    btnJudge2Top5Send.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private Timer timerJ2Name;
        public void InitTimerJ2Name()
        {
            timerJ2Name = new Timer();
            timerJ2Name.Tick += new EventHandler(timerJudge2Name_Tick);
            timerJ2Name.Interval = 3000; // in milliseconds
            timerJ2Name.Start();
        }

        private void timerJudge2Name_Tick(object sender, EventArgs e)
        {
            if (cmbCategories.SelectedIndex == 0)
            {
                timerJ2Name.Start();
        ...
        private void btnScoreCandidate1_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate1())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score1 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update1(judge2BLL);
                    judge2DAL.UpdateDependency1(judge2BLL);
        ...
        private void btnScoreCandidate2_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate2())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score2 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update2(judge2BLL);
                    judge2DAL.UpdateDependency2(judge2BLL);
        ...
        private void btnScoreCandidate3_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate3())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score3 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update3(judge2BLL);
                    judge2DAL.UpdateDependency3(judge2BLL);
        ...
        private void btnScoreCandidate4_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate4())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score4 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update4(judge2BLL);
                    judge2DAL.UpdateDependency4(judge2BLL);
        ...
        private void btnScoreCandidate5_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate5())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score5 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update5(judge2BLL);
                    judge2DAL.UpdateDependency5(judge2BLL);
        ...
        private void btnScoreCandidate6_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate6())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score6 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update6(judge2BLL);
                    judge2DAL.UpdateDependency6(judge2BLL);
        ...
        private void btnScoreCandidate7_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate7())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score7 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update7(judge2BLL);
                    judge2DAL.UpdateDependency7(judge2BLL);
        ...
        private void btnScoreCandidate8_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate8())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score8 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update8(judge2BLL);
                    judge2DAL.UpdateDependency8(judge2BLL);
        ...
        private void btnScoreCandidate9_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate9())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score9 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update9(judge2BLL);
                    judge2DAL.UpdateDependency9(judge2BLL);
        ...
        private void btnScoreCandidate10_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate10())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score10 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update10(judge2BLL);
                    judge2DAL.UpdateDependency10(judge2BLL);
        ...
        private void btnScoreCandidate11_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate11())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score11 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update11(judge2BLL);
                    judge2DAL.UpdateDependency11(judge2BLL);
        ...
        private void btnScoreCandidate12_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate12())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score12 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update12(judge2BLL);
                    judge2DAL.UpdateDependency12(judge2BLL);
        ...
        private void btnScoreCandidate13_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate13())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score13 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update13(judge2BLL);
                    judge2DAL.UpdateDependency13(judge2BLL);
        ...
        private void btnScoreCandidate14_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate14())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score14 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update14(judge2BLL);
                    judge2DAL.UpdateDependency14(judge2BLL);
        ...
        private void btnScoreCandidate15_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate15())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge2BLL.Score15 = total;


                    // Updating data into Database
                    bool success = judge2DAL.Update15(judge2BLL);
                    judge2DAL.UpdateDependency15(judge2BLL);
        ...
        private void btnSendToBackBestInTalentPanel_Click(object sender, EventArgs e)
        {
            ...
            lblCandidateName.ForeColor = Color.OrangeRed;
            lblScore.ForeColor = Color.OrangeRed;
            btnJudge2TalentSend.SendToBack();
            panelBody.BringToFront();
            Clear();
