...
{
    public partial class frmJudge4 : Form
    {
        public frmJudge4()
        {
            InitializeComponent();
        ...
        private async void frmJudge4_Load(object sender, EventArgs e)
        {
        ...
        public void FillTxtboxJudge4Name()
        {
            using (SqlConnection conn = new SqlConnection(UserDAL.myconnstrng))
            {
                string query = "SELECT Judge4Name FROM tbl_JudgesAndAdmin";
                SqlCommand cmd = new SqlCommand(query, conn);
        ...
        private void cmbCategories_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                InitTimerJ4Name();
                panelWelcomeJudge4.BringToFront();
                lblJudgeName.Focus();
            }
            else if (cmbCategories.SelectedIndex == 1)
            {
                btnJudge4TalentSend.Visible = true;

                btnJudge4ProductionNumberSend.Visible = false;
                btnJudge4EveningGownSend.Visible = false;
                btnJudge4ResortWearSend.Visible = false;
                btnJudge4OnStageQuestionsSend.Visible = false;
                ...
                btnJudge4TalentSend.BringToFront();
            ...
            {
                btnJudge4ProductionNumberSend.Visible = true;

                btnJudge4TalentSend.Visible = false;
                btnJudge4EveningGownSend.Visible = false;
                btnJudge4ResortWearSend.Visible = false;
                btnJudge4OnStageQuestionsSend.Visible = false;
                ...
                btnJudge4ProductionNumberSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge4EveningGownSend.Visible = true;
                ...
                btnJudge4EveningGownSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge4ResortWearSend.Visible = true;
                ...
                btnJudge4ResortWearSend.BringToFront();
                panelBody.BringToFront();
                Clear();
            ...
            {
                btnJudge4OnStageQuestionsSend.Visible = true;
                ...
                btnJudge4OnStageQuestionsSend.BringToFront();
                panelBody.BringToFront();
                Clear();
        ...
        JudgeBLL judge4BLL = new JudgeBLL();
        Judge4TalentDAL judge4TalentDAL = new Judge4TalentDAL();
        private void SendScoreJudge4Talent()
        {
            ...
            judge4BLL.Score1 = score1;
            judge4BLL.Score2 = score2;
            judge4BLL.Score3 = score3;
            judge4BLL.Score4 = score4;
            judge4BLL.Score5 = score5;
            judge4BLL.Score6 = score6;
            judge4BLL.Score7 = score7;
            judge4BLL.Score8 = score8;
            judge4BLL.Score9 = score9;
            judge4BLL.Score10 = score10;
            judge4BLL.Score11 = score11;
            judge4BLL.Score12 = score12;
            judge4BLL.Score13 = score13;
            judge4BLL.Score14 = score14;
            judge4BLL.Score15 = score15;

            // Updating data into Database
            bool success = judge4TalentDAL.Update1(judge4BLL);
            judge4TalentDAL.Update2(judge4BLL);
            judge4TalentDAL.Update3(judge4BLL);
            judge4TalentDAL.Update4(judge4BLL);
            judge4TalentDAL.Update5(judge4BLL);
            judge4TalentDAL.Update6(judge4BLL);
            judge4TalentDAL.Update7(judge4BLL);
            judge4TalentDAL.Update8(judge4BLL);
            judge4TalentDAL.Update9(judge4BLL);
            judge4TalentDAL.Update10(judge4BLL);
            judge4TalentDAL.Update11(judge4BLL);
            judge4TalentDAL.Update12(judge4BLL);
            judge4TalentDAL.Update13(judge4BLL);
            judge4TalentDAL.Update14(judge4BLL);
            judge4TalentDAL.Update15(judge4BLL);

            // If the data is successfully updated then the value of success will be true else it will be false
            if (success == true)
            {
                // Data successfully updated
                MessageBox.Show("Thank you, for sending the scores '" + lblJudgeName.Text + "'.", "Judge4 Sent Successfully!", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                // Failed to update data
                MessageBox.Show("Failed to send new score information.", "Judge4 Information Warning!", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            }
        }

        Judge4ProductionNoDAL judge4ProductionNoDAL = new Judge4ProductionNoDAL();
        private void SendScoreJudge4ProductionNo()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            judge4BLL.Total = total;

            // Updating data into Database
            bool success = judge4ProductionNoDAL.Update1(judge4BLL);
            judge4ProductionNoDAL.Update2(judge4BLL);
            judge4ProductionNoDAL.Update3(judge4BLL);
            judge4ProductionNoDAL.Update4(judge4BLL);
            judge4ProductionNoDAL.Update5(judge4BLL);
            judge4ProductionNoDAL.Update6(judge4BLL);
            judge4ProductionNoDAL.Update7(judge4BLL);
            judge4ProductionNoDAL.Update8(judge4BLL);
            judge4ProductionNoDAL.Update9(judge4BLL);
            judge4ProductionNoDAL.Update10(judge4BLL);
            judge4ProductionNoDAL.Update11(judge4BLL);
            judge4ProductionNoDAL.Update12(judge4BLL);
            judge4ProductionNoDAL.Update13(judge4BLL);
            judge4ProductionNoDAL.Update14(judge4BLL);
            judge4ProductionNoDAL.Update15(judge4BLL);

            judge4ProductionNoDAL.UpdateDependency1(judge4BLL);
        ...
        Judge4EveningGownDAL judge4EveningGownDAL = new Judge4EveningGownDAL();
        private void SendScoreJudge4EveningGown()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge4EveningGownDAL.Update1(judge4BLL);
            judge4EveningGownDAL.Update2(judge4BLL);
            judge4EveningGownDAL.Update3(judge4BLL);
            judge4EveningGownDAL.Update4(judge4BLL);
            judge4EveningGownDAL.Update5(judge4BLL);
            judge4EveningGownDAL.Update6(judge4BLL);
            judge4EveningGownDAL.Update7(judge4BLL);
            judge4EveningGownDAL.Update8(judge4BLL);
            judge4EveningGownDAL.Update9(judge4BLL);
            judge4EveningGownDAL.Update10(judge4BLL);
            judge4EveningGownDAL.Update11(judge4BLL);
            judge4EveningGownDAL.Update12(judge4BLL);
            judge4EveningGownDAL.Update13(judge4BLL);
            judge4EveningGownDAL.Update14(judge4BLL);
            judge4EveningGownDAL.Update15(judge4BLL);

            judge4EveningGownDAL.UpdateDependency1(judge4BLL);
        ...
        Judge4ResortWearDAL judge4ResortWearDAL = new Judge4ResortWearDAL();
        private void SendScoreJudge4ResortWear()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge4ResortWearDAL.Update1(judge4BLL);
            judge4ResortWearDAL.Update2(judge4BLL);
            judge4ResortWearDAL.Update3(judge4BLL);
            judge4ResortWearDAL.Update4(judge4BLL);
            judge4ResortWearDAL.Update5(judge4BLL);
            judge4ResortWearDAL.Update6(judge4BLL);
            judge4ResortWearDAL.Update7(judge4BLL);
            judge4ResortWearDAL.Update8(judge4BLL);
            judge4ResortWearDAL.Update9(judge4BLL);
            judge4ResortWearDAL.Update10(judge4BLL);
            judge4ResortWearDAL.Update11(judge4BLL);
            judge4ResortWearDAL.Update12(judge4BLL);
            judge4ResortWearDAL.Update13(judge4BLL);
            judge4ResortWearDAL.Update14(judge4BLL);
            judge4ResortWearDAL.Update15(judge4BLL);

            judge4ResortWearDAL.UpdateDependency1(judge4BLL);
        ...
        Judge4OnStageQuestionsDAL judge4OnStageQuestionsDAL = new Judge4OnStageQuestionsDAL();
        private void SendScoreJudge4OnStageQuestions()
        {
            float score1, score2, score3, score4, score5, score6, score7, score8, score9, score10, score11, score12, score13, score14, score15;
            float.TryParse(txtScore1.Text, out score1);
            float.TryParse(txtScore2.Text, out score2);
            ...
            // Updating data into Database
            bool success = judge4OnStageQuestionsDAL.Update1(judge4BLL);
            judge4OnStageQuestionsDAL.Update2(judge4BLL);
            judge4OnStageQuestionsDAL.Update3(judge4BLL);
            judge4OnStageQuestionsDAL.Update4(judge4BLL);
            judge4OnStageQuestionsDAL.Update5(judge4BLL);
            judge4OnStageQuestionsDAL.Update6(judge4BLL);
            judge4OnStageQuestionsDAL.Update7(judge4BLL);
            judge4OnStageQuestionsDAL.Update8(judge4BLL);
            judge4OnStageQuestionsDAL.Update9(judge4BLL);
            judge4OnStageQuestionsDAL.Update10(judge4BLL);
            judge4OnStageQuestionsDAL.Update11(judge4BLL);
            judge4OnStageQuestionsDAL.Update12(judge4BLL);
            judge4OnStageQuestionsDAL.Update13(judge4BLL);
            judge4OnStageQuestionsDAL.Update14(judge4BLL);
            judge4OnStageQuestionsDAL.Update15(judge4BLL);

            judge4OnStageQuestionsDAL.UpdateDependency1(judge4BLL);
        ...
        Judge4Top5DAL judge4Top5DAL = new Judge4Top5DAL();
        private void SendScoreJudge4Top5()
        {
            ...
            // Updating data into Database
            bool success = judge4Top5DAL.Update1(judge4BLL);
            judge4Top5DAL.Update2(judge4BLL);
            judge4Top5DAL.Update3(judge4BLL);
            judge4Top5DAL.Update4(judge4BLL);
            judge4Top5DAL.Update5(judge4BLL);

            judge4Top5DAL.UpdateDependency1(judge4BLL);
        ...
        private void btnJudge4TalentSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorFormBestInTalent())
            {
                ...
                {
                    FillTxtboxJudge4Name();
                    SendScoreJudge4Talent();

                    btnJudge4TalentSend.Enabled = false;
                    btnJudge4TalentSend.LabelText = "Scores already sent!";
                    btnJudge4TalentSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge4ProductionNumberSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    FillTxtboxJudge4Name();
                    SendScoreJudge4ProductionNo();

                    btnJudge4ProductionNumberSend.Enabled = false;
                    btnJudge4ProductionNumberSend.LabelText = "Scores already sent!";
                    btnJudge4ProductionNumberSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge4EveningGownSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge4EveningGown();

                    btnJudge4EveningGownSend.Enabled = false;
                    btnJudge4EveningGownSend.LabelText = "Scores already sent!";
                    btnJudge4EveningGownSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge4ResortWearSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge4ResortWear();

                    btnJudge4ResortWearSend.Enabled = false;
                    btnJudge4ResortWearSend.LabelText = "Scores already sent!";
                    btnJudge4ResortWearSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge4OnStageQuestionsSend_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    SendScoreJudge4OnStageQuestions();

                    btnJudge4OnStageQuestionsSend.Enabled = false;
                    btnJudge4OnStageQuestionsSend.LabelText = "Scores already sent!";
                    btnJudge4OnStageQuestionsSend.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private void btnJudge4Top5Send_Click(object sender, EventArgs e)
        {            
            if (ValidatorForm())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    btnJudge4Top5Send.Enabled = false;
                    btnJudge4Top5Send.LabelText = "Scores already sent!";
                    btnJudge4Top5Send.Font = new Font("Arial", 10, FontStyle.Regular); 
                }
            }             
        }

        private Timer timerJ4Name;
        public void InitTimerJ4Name()
        {
            timerJ4Name = new Timer();
            timerJ4Name.Tick += new EventHandler(timerJudge4Name_Tick);
            timerJ4Name.Interval = 3000; // in milliseconds
            timerJ4Name.Start();
        }

        private void timerJudge4Name_Tick(object sender, EventArgs e)
        {
            if (cmbCategories.SelectedIndex == 0)
            {
                timerJ4Name.Start();
        ...
        private void btnScoreCandidate1_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate1())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score1 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update1(judge4BLL);
                    judge4TalentDAL.UpdateDependency1(judge4BLL);
        ...
        private void btnScoreCandidate2_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate2())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score2 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update2(judge4BLL);
                    judge4TalentDAL.UpdateDependency2(judge4BLL);
        ...
        private void btnScoreCandidate3_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate3())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score3 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update3(judge4BLL);
                    judge4TalentDAL.UpdateDependency3(judge4BLL);
        ...
        private void btnScoreCandidate4_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate4())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score4 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update4(judge4BLL);
                    judge4TalentDAL.UpdateDependency4(judge4BLL);
        ...
        private void btnScoreCandidate5_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate5())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score5 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update5(judge4BLL);
                    judge4TalentDAL.UpdateDependency5(judge4BLL);
        ...
        private void btnScoreCandidate6_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate6())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score6 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update6(judge4BLL);
                    judge4TalentDAL.UpdateDependency6(judge4BLL);
        ...
        private void btnScoreCandidate7_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate7())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score7 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update7(judge4BLL);
                    judge4TalentDAL.UpdateDependency7(judge4BLL);
        ...
        private void btnScoreCandidate8_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate8())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score8 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update8(judge4BLL);
                    judge4TalentDAL.UpdateDependency8(judge4BLL);
        ...
        private void btnScoreCandidate9_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate9())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score9 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update9(judge4BLL);
                    judge4TalentDAL.UpdateDependency9(judge4BLL);
        ...
        private void btnScoreCandidate10_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate10())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score10 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update10(judge4BLL);
                    judge4TalentDAL.UpdateDependency10(judge4BLL);
        ...
        private void btnScoreCandidate11_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate11())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score11 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update11(judge4BLL);
                    judge4TalentDAL.UpdateDependency11(judge4BLL);
        ...
        private void btnScoreCandidate12_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate12())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score12 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update12(judge4BLL);
                    judge4TalentDAL.UpdateDependency12(judge4BLL);
        ...
        private void btnScoreCandidate13_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate13())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score13 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update13(judge4BLL);
                    judge4TalentDAL.UpdateDependency13(judge4BLL);
        ...
        private void btnScoreCandidate14_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate14())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score14 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update14(judge4BLL);
                    judge4TalentDAL.UpdateDependency14(judge4BLL);
        ...
        private void btnScoreCandidate15_Click(object sender, EventArgs e)
        {
            if (ValidatorFormBestInTalentCandidate15())
            {
                if (DialogResult.Yes == MessageBox.Show("Are you sure you want to send the scores? You can't send again after you click yes.", "Sending Scores!", MessageBoxButtons.YesNo, MessageBoxIcon.Question))
                {
                    ...
                    // Getting data from UI
                    judge4BLL.Score15 = total;


                    // Updating data into Database
                    bool success = judge4TalentDAL.Update15(judge4BLL);
                    judge4TalentDAL.UpdateDependency15(judge4BLL);
        ...
        private void btnSendToBackBestInTalentPanel_Click(object sender, EventArgs e)
        {
            ...
            lblCandidateName.ForeColor = Color.OrangeRed;
            lblScore.ForeColor = Color.OrangeRed;
            btnJudge4TalentSend.SendToBack();
            panelBody.BringToFront();
            Clear();
